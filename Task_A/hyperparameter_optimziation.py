# -*- coding: utf-8 -*-
"""
Created on Fri Feb 28 12:39:04 2020
...
class PyTorchWorker(Worker):
    def __init__(self, **kwargs):
        ...
        self.train_temporal_data = torch.load('data/train_temporal_data.pt') #and torch.load('file.pt')
